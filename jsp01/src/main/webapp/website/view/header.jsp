...
<meta charset="UTF-8">
	...
	<!-- css 호출 -->
	<link rel="stylesheet" href="/jsp01/website/css/main.css">
			...
			<header class="py-3">
				<div class="row"> <!-- 가로배치 -->
					...
					<div class="col-md-4 d-flex justify-content-end " class="headermenu"> <!-- 상단메뉴 -->
						<ul class="nav">
							<%if(loginid!=null&&loginid.equals("admin")){%><li> <a href="/jsp01/website/view/admin/productview.jsp"> 관리자 </a> </li> <%}%>
							<%if(loginid!=null){ %>
							<li class="header-menu"> <a href="/jsp01/website/view/member/myinfo.jsp"> 내정보 </a> </li>
							<li class="header-menu"> <a href="/jsp01/website/view/main.jsp?result=false" id="logout" > 로그아웃 </a> </li>
						<% }else{ %>
							<li class="header-menu"> <a href="/jsp01/website/view/member/signup.jsp">회원가입</a> </li>
							<li class="header-menu"> <a href="/jsp01/website/view/member/login.jsp">로그인</a> </li>
						<% }%>
						</ul>
					</div>
				</div>			
			...
			<nav class="navbar navbar-expand-lg navbar-light bg-white">
				...
				<div class="collapse navbar-collapse" id="manubar">
					<ul class="navbar-nav col-md-12 justify-content-between">
						<li class="nav-item"> <a href="/jsp01/website/view/admin/dashboard.jsp" class="nav-link">신차</a> </li>
