...
<body>
	...
	<%if(request.getParameter("result")!=null&&request.getParameter("result").equals("false")){session.removeAttribute("login");}%>
	<%@include file="header.jsp" %>
		...
		<div id="contents" class="carousel slide" data-ride="carousel" data-interval="2000">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item"> <img alt="" src="/jsp01/website/img/메인2.jpg"> </div>
				<div class="carousel-item"> <img alt="" src="/jsp01/website/img/메인3.jpg"> </div>
			</div>
		</div>
