...
public class Day02_2 {
	...
	//변수는 선언된 블록 내에서만 가능하다 [ 괄호 안으로 이동 가능 // 괄호 밖으로는 이동 불가]
	...
	//	byte var4 = 128; 	System.out.println(var4);
		byte var4 = 'A'; 	System.out.println(var4);
	   ...
	   // short num2 = 40000; System.out.println(num2);
	    ...
	    // p46 : Long [8byte ] : 20억 이상
	       Long num5 = 2000000000L; System.out.println(num5);
	       
	    // p47~47  : float[4바이트] , double [ *기본 실수 자료형 / 8바이트 ]
	 ...
	 // float val2 =3.14; 	System.out.println(val2);
	    ...
	    //p49 : 타입변환
	      //1. 자동 타입변환 [크기순 : 작은 상자에서 큰상자로 이동 가능]
	          // byte => short => int => long => float => double
	          // 반대는 물가
	          // 작은상자에서 큰상자로 이동가능 // 큰상자에서 작은상자로 이동불가능
	    byte bytevalue = 10 ;
	    ...
	    char cahr2 = ' '; // 값 없음 <-> 공백 [다름]
	    double double2 =  10; System.out.println(double2);
